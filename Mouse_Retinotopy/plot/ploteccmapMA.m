function imout = ploteccmapMA(im,rng,xdom,ydom)
% eg.
% im = imdum; rng =[1.1 2.1];
...
% figure
imagesc(xdom, ydom, imout), axis image
...
%% Log
%{
- Mohammad 2015; wrote the file. This is based on Garret 2014 shared code
%}